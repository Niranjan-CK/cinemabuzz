...
export const MovieDetails=()=>{
    ...
    useEffect(()=>{
        async function fetchMovie(){
            ...
            const response = await fetch(`https://api.themoviedb.org/3/movie/${param.id}?api_key=49bda1284ab954374255035ef8dd097b`)
    ...
    return(
        <main>
            <section className="flex justify-around flex-wrap py-5">
                ...
                <div className="max-w-2xl text-gray-700 text-lg dark:text-white px-8">
